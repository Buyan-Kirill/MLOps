...
После этого всю дальнейшую работу можно будет делать через Makefile. Для просмотра команд в терминале, выполните команду make help. Там есть команды для запуска полного цикла:
