...
После этого всю дальнейшую работу можно будет делать через Makefile. Для просмотра команд, доступных через make, вызовите make help. Ниже представлен пайплайн системы с командами для их вызова:
